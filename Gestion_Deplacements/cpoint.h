...
/**
 * \class CPoint
 * \brief Classe de base pour les différents type de points
 *
 * CPoint est une classe de base dont hérite les classes typées de points
 * (CPRect, CPRond...)
 * Contient toutes les variables d'une étape.
 */
...
public:
    CPoint(int X, int Y, QColor Color);
    virtual ~CPoint();
